  ...
  return (
    <section ref={containerRef} className="relative h-screen min-h-[600px] flex items-center justify-center overflow-hidden">
      <motion.div
        ...
        style={{ backgroundImage: "url('/images/1000283334.jpg')" }}
      ...
      <div ref={textRef} className="relative z-10 text-center px-4">
        <span className="text-base tracking-[0.4em] uppercase text-gold block mb-4 font-semibold">Fine Dining</span>
        <h1 className="text-6xl md:text-8xl lg:text-9xl font-heading font-bold text-ivory mb-4">RANGREZZA</h1>
        <p className="text-2xl md:text-3xl lg:text-4xl font-subheading text-ivory/80 italic">Fine Dining Redefined</p>
      </div>
